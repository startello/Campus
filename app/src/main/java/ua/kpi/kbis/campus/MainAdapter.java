        ...
        public void onClick(View v) {
            try {
                ActivityOptionsCompat options = ActivityOptionsCompat.makeSceneTransitionAnimation(
                    (MainActivity) mContext, mCaption, "mCaption");
                ActivityCompat.startActivity((MainActivity) mContext, new Intent(mContext, ViewBulletin.class).putExtra("item", MainActivity.currentUser.getJSONArray("bulletins").getJSONObject(getPosition()).toString()),
                        options.toBundle());
            } catch (JSONException e) {
                e.printStackTrace();
            }
